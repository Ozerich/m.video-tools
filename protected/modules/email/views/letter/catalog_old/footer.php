        ...
        <table width="600" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td width="159" valign="top"><br>
                    <?= HtmlHelper::Link('http://spb.mvideo.ru/discount/', HtmlHelper::Font('Акции', array('size' => 12, 'bold' => true, 'line-height' => 18, 'underline' => true)), 'a_foot_menu'); ?>
                    <br>
                    ...
                    <?= HtmlHelper::Link('http://spb.mvideo.ru/deal_of_the_day/', HtmlHelper::Font('Товар дня', array('size' => 12, 'line-height' => 18, 'underline' => true)), 'a_foot_menu'); ?>
                    <br>
                    <?= HtmlHelper::Link('http://spb.mvideo.ru/discount/', HtmlHelper::Font('Все акции', array('size' => 12, 'line-height' => 18, 'underline' => true)), 'a_foot_menu'); ?>
                </td>
                    ...
                    <td width="<?= $column['width'] ?>" valign="top"><br>
                        <? foreach ($column['items'] as $label => $category): ?>
                            <? if (isset($category['url'])): ?>
                                <?= HtmlHelper::Link('http://spb.mvideo.ru/' . $category['url'], HtmlHelper::Font($label, array('bold' => true, 'line-height' => 18, 'underline' => true)), 'a_foot_menu'); ?>
                            <? else: ?>
                            ...
                            <? if (isset($category['children'])): foreach ($category['children'] as $label => $link): ?>
                                <?= HtmlHelper::Link('http://spb.mvideo.ru/' . $link, HtmlHelper::Font($label, array('line-height' => 18, 'underline' => true)), 'a_foot_menu'); ?>
                                <br>
                            <? endforeach; endif; ?>
                        <? endforeach; ?>
                    </td>
    ...
    <td colspan="2">
        ...
        <font size="1" face="Tahoma, sans-serif;" color="#898989"
            ...
            <? foreach ($letter->stocks as $stock): if ($stock->on_footer): ?>
                ...
                ООО «М.видео Менеджмент», включая интернет-магазин (покупки, сделанные посредством интернет-сайта <?=HtmlHelper::Link('http://spb.mvideo.ru/', HtmlHelper::Font('mvideo.ru', array('size' => 11, 'color' => 'red', 'underline' => true)), 'a_foot_links')?>). Пожалуйста, ознакомьтесь с <?=HtmlHelper::Link($stock->url, HtmlHelper::Font('правилами акции', array('size' => 11, 'color' => 'red', 'underline' => true)), 'a_foot_links')?>.
                <br><br>
				<? else: ?>
...
<br>
            ...
            <? $texts = array(
                ...
                HtmlHelper::Link('http://spb.mvideo.ru/disclaimer/', HtmlHelper::Font('Политика конфиденциальности', array('size' => 11, 'color' => 'red', 'underline' => true)), 'a_foot_links') . '.',
            );?>
