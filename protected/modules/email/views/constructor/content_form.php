...
<div class="form-container" style="display: none">
    ...
    <div class="form-inner">
        ...
        <div class="param-container param-product-container"
            ...
            <div class="param">
                ...
                <input type="text" class="form-control" name="category"
                       value="<?= $model ? htmlentities($model->product_category) : '' ?>">
            </div>
            <div class="param">
                <label>Модель товара:</label>
                <input type="text" class="form-control" name="model" value="<?= $model ? htmlentities($model->product_model) : '' ?>">
            </div>
            <div class="param">
                <label>Дополнительный текст:</label>
                <input type="text" class="form-control" name="name_additional" value="<?= $model ? htmlentities($model->product_name_additional) : '' ?>">
            </div>
        ...
        <div class="param-container param-banner-container"
			...
			<div class="param">
                <label>Альтертекст:</label>
                <input type="text" name="alt" class="form-control input-alt"
                       value="<?= $type == LetterCatalogBlock::TYPE_BANNER && $model ? $model->alt : '' ?>">
            </div>
            <div class="param">
                <label>Utm Content:</label>
                <input type="text" name="utm_content" class="form-control input-utm"
                       value="<?= $type == LetterCatalogBlock::TYPE_BANNER && $model ? $model->utm_content : '' ?>">
            </div>
        </div>
